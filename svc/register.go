...
const SVC_NODE_ROOT = "/lark.data.auto_transform/svc_node/"
const All_TASK_ROOT = "/lark.data.auto_transform/all_task/"
const TASK_NODE_ROOT = "/lark.data.auto_transform/task_node/"
const SVC_ELECTION = "/lark.data.auto_transform/election/"
/*
@Desc :
